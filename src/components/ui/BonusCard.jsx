  ...
  return (
    ...
    >
      <div className="bg-[#0F2033] border-2 border-[#FBBF24] overflow-hidden flex flex-col sm:flex-row group hover:border-white/40 transition-colors shadow-[4px_4px_0_#B8860B] relative">
        <div className="sm:w-2/5 aspect-square sm:aspect-auto overflow-hidden relative bg-black/30">
          <div className="absolute top-2 left-2 bg-[#B91C1C] text-white text-[9px] font-black px-2 py-1 uppercase tracking-wider z-10">BONO GRATIS</div>
          <img
            src={bono.img}
            alt={bono.alt}
            loading="lazy"
            ...
            onError={(e) => { e.target.src = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200' fill='%230F2033'%3E%3Crect width='200' height='200'/%3E%3Ctext x='50%25' y='50%25' dominant-baseline='middle' text-anchor='middle' font-family='sans-serif' font-size='12' fill='%23aaa'%3EImage%3C/text%3E%3C/svg%3E"; }}
          />
        </div>
